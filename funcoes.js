...
// temos 3 formas de escrever funções
// 1) declara função com parametro
function imprimeTexto(texto){
    console.log(texto);
}

imprimeTexto('oi');
imprimeTexto('reaproveitando a função');

// 2) declara função sem parametro:
function soma(){
    //o return sempre deve ser a ultima da função
    //outros codigos
    //varios console.log()
    //etc
    return 2 + 2;
...
// 3) uma função dentro de outra função
